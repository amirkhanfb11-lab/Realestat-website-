...
export function DeleteConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <h3 id="delete-message-title" className="text-base font-semibold text-navy-950">
          Delete message?
        </h3>
        <p className="mt-2 text-sm text-gray-500">
          This will permanently remove the message from &ldquo;{itemLabel}&rdquo;. This can&apos;t be undone.
        </p>
